...
<div class="wcbe-modal" id="wcbe-modal-schedule-job-edit-items">
        ...
        <div class="wcbe-modal-box wcbe-modal-box-sm">
            <div class="wcbe-modal-content">
                <div class="wcbe-modal-title">
                    <h2><?php esc_html_e('Edit Items', 'ithemeland-woo-bulk-product-editor-lite'); ?></h2>
                ...
                <div class="wcbe-modal-body">
                    <div class="wcbe-modal-body-content">
                        <div class="wcbe-wrap">
                            <div class="wcbe-schedule-job-edit-items-loading">
                                <img src="<?php echo esc_url(WCBEL_IMAGES_URL . 'loading-2.gif'); ?>" width="20" height="20" />
                            </div>

                            <div class="wcbe-schedule-job-edit-items-container">
