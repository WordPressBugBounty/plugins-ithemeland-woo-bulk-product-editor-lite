...
class AnalyticsStats
{
    ...
    private function get_default_stats()
    {
        return [
            'plugin' => 'wcbel',
            'type' => 'lite',
            'site_id' => md5(get_site_url() . 'wcbel'),
            'plugin_version' => WCBEL_VERSION,
            'analytics_items' => [],
            'domain' => get_site_url(),
            ...
            'server_info' => [
                'server_software' => $_SERVER['SERVER_SOFTWARE'] ?? '', //phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
                'php_memory_limit' => ini_get('memory_limit')
            ]
        ];
    }
    ...
    private function get_plugin_settings()
    {
        ...
        return [
            'some_setting' => get_option('wcbel_some_setting', 'default')
        ];
    }
}
