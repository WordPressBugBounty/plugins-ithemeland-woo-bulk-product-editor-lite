    ...
    <ul class="wcbe-sub-tab">
        ...
        <li>
            <button <?php echo !defined('WCBE_ACTIVE') ? 'disabled="disabled" class="wcbe-lite-version"' : ''; ?> type="button" id="wcbe-bulk-edit-redo">
                <svg fill="#444" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="14px" height="14px"
                    viewBox="0 0 454.839 454.839" xml:space="preserve">
                    <g>
                        <path d="M49.931,283.853c0,94.282,76.71,170.986,170.986,170.986h60.526
                            c10.03,0,18.158-8.127,18.158-18.157v-6.053
                            c0-10.031-8.127-18.158-18.158-18.158h-60.526
                            c-70.917,0-128.618-57.701-128.618-128.618
                            c0-70.917,57.701-128.618,128.618-128.618
                            h111.667l-76.905,76.905
                            c-8.26,8.257-8.26,21.699,0,29.956
                            c8.015,8.009,21.964,7.997,29.961,0
                            L398.702,149.031
                            c4.001-4.001,6.206-9.321,6.206-14.981
                            c0-5.656-2.205-10.979-6.206-14.978
                            L285.634,6.002
                            c-7.997-8.003-21.958-8.003-29.956,0
                            c-8.26,8.255-8.26,21.699,0,29.953
                            l76.905,76.911H220.917
                            C126.641,112.866,49.931,189.573,49.931,283.853z" />
                    </g>
                </svg>
