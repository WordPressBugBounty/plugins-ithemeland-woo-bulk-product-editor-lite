...
$wcbel_items = $edit_form_items['general'];

foreach ($wcbel_items as $wcbel_name => $wcbel_item):
    $wcbel_field_id_key = isset($wcbel_item['id']) ? $wcbel_item['id'] : '';
    $wcbel_field_id = 'wcbe-bulk-edit-form-product-' . esc_attr($wcbel_field_id_key);
...
?>
    <div class="wcbe-form-group" data-name="<?php echo esc_attr($wcbel_name); ?>" data-type="<?php echo esc_attr($wcbel_item['update_type']); ?>">
        <div>
            ...
            <?php if (isset($wcbel_item['variable']) && $wcbel_item['variable'] && !(isset($wcbel_item['disabled']) && $wcbel_item['disabled'])): ?>
